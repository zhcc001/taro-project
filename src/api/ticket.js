...
//接口类型
const tourTypeId=10043
// 门票列表
export function getTicketList(arriveCityId,daysRange,orderBys,name,ps,pi) {
    const url = `/api/tour/info?tourTypeId=${tourTypeId}&arriveCityId=${arriveCityId}&daysRange=${daysRange}&orderBys=${orderBys}&name=${name}&ps=${ps}&pi=${pi}`
