...
import {getOrderDatail,submitOrder,payOrder} from '../../../../api/touristRoutes'
              ...
              <View className="container">
               < View className = "box" >
                ...
                <View className="msgTextBox">
                  ...
                  {orderDetailObj.ProductOrder.ChildCount!=0&&<View className="rightText">￥{orderDetailObj.ProductOrder.ChildSalePrice}*{orderDetailObj.ProductOrder.ChildCount}</View>}
                </View>
                <View className="msgTextBox">
