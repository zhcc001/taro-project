...
import {getPrice,getOninfo,submitOrder,payOrder} from '../../../../api/ticket'
...
gotoSuccess(){
  Taro.redirectTo({
    url: `/pages/admissionTicket/pages/ticketPaySuccess/index`
  })
}
// 分享
  ...
  Taro.showLoading({
    ...
    .then(res=>{
      if(res.Success){
        Taro.hideLoading()
        Taro.redirectTo({
          url: `/pages/admissionTicket/pages/ticketOrderDetail/index?orderNumber=${res.Result}`
      ...
      <View className='reserveTicket'>
        ...
        <View className='orderMsgMaskTitle'>
          ...
          <View class="hangBanMsg">
              <View class="biaoTi"><Text>门票信息</Text></View>
